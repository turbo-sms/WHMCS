...
$valid = '<div style="text-align: left;background-color: green;margin: 0px;padding: 5px; border: 1px solid #fc0000;color: white;"> You have successfully Connected with Turbo SMS Server
            </div>'; 
          
            
            $ivalid = '<div style="text-align: left;background-color: red;margin: 0px;padding: 5px; border: 1px solid #fc0000;color: white;"> You are Disconnected from Turbo SMS Server
            </div>';
        $url = 	"http://turbosms.top/miscapi/$authK/getBalance";
